...
const Document3 = require('../../model/document3');
...
Page({
  ...
  fetchDocuments: function () {
    ...
    const query = new AV.Query(Document3).ascending('createdAt');
  ...
  showDocument(e){
    ...
    // const currPage = this;
    // var query = new AV.Query(Document3);
    ...
    //   var document = AV.Object.createWithoutData('Document3', document);
    //   // 修改属性
