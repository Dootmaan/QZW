...
const Document2 = require('../../model/document2');
...
Page({
  ...
  fetchDocuments: function () {
    ...
    const query = new AV.Query(Document2).ascending('createdAt');
  ...
  showDocument(e){
    ...
    // const currPage = this;
    // var query = new AV.Query(Document2);
    ...
    //   var document = AV.Object.createWithoutData('Document2', document);
    //   // 修改属性
