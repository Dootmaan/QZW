...
Page({ 
  ...
  onLoad() {
    ...
    // console.log((this.data.exposure_publishs));
    this.getPubsTime(this.data.exposure_publishs);
  ...
  setExposurePublishs: function (exposure_publishs) {
    ...
    this.getPubsTime(exposure_publishs);
  ...
  comment(e){
    ...
    wx.navigateTo({
      url: '/pages/exposure/exposure_comment?exposure_publish=' + exposure_publish + '&userNickName=' + userNickName + '&userAvatarUrl=' + userAvatarUrl + '&pubtime=' + pubtime,
    })
  },
  likePublish(e){
    console.log(e);
  ...
  getPubsTime(data) {
    ...
    console.log(pubsTime_arr);
    currPage.setData({pubsTime: pubsTime_arr });
